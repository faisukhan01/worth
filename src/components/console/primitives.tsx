...
export function KpiTile({
  ...
  return (
    <div
      className={cn(
        'card-surface group relative overflow-hidden p-4 transition-all duration-200 hover:-translate-y-0.5 hover:border-ring/40 hover:shadow-lg hover:shadow-black/20',
        className,
      )}
    >
